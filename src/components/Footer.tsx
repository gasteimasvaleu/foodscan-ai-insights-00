...
export const Footer = () => {
  ...
  return (
    <footer className="bg-white/80 backdrop-blur-md border-t border-white/20 shadow-sm mt-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-600 text-sm">contato@foodscandiet.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-4 h-4 text-primary-600" />
                <span className="text-gray-600 text-sm">(11) 9999-9999</span>
              </div>
              <div className="flex items-center space-x-3">
