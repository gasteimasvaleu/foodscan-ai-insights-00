  ...
  return (
    <div className="relative">
      <motion.button
        ...
        className={cn(
          "group relative grid overflow-hidden rounded-xl px-6 py-3 font-semibold shadow-lg hover:shadow-xl transition-all duration-300",
          status === "idle"
            ? "shadow-[0_1000px_0_0_hsl(0_0%_85%)_inset]"
            : "",
          "hover:shadow-lg",
          className
        )}
