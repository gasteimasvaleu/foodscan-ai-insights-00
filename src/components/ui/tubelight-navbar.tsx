...
export function TubelightNavbar({ items, className }: NavBarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 sm:gap-3 <div className="flex items-center gap-2 sm:gap-3 bg-[#FA1690]/85 border border-white/20 backdrop-blur-lg py-2 px-2 sm:px-3 rounded-2xl shadow-none"> border border-white/20 backdrop-blur-lg py-2 px-2 sm:px-3 rounded-2xl shadow-none">
        {items.map((item) => {
