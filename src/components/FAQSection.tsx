...
export const FAQSection = () => {
  ...
  return (
    <section className="bg-white/30 backdrop-blur-sm rounded-3xl p-8 border border-gray-100 my-8">
      <motion.div
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="bg-white/50 backdrop-blur-sm rounded-xl border border-gray-200 px-6 py-2"
              >
