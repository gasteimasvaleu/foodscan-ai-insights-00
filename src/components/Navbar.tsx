...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 <nav className="fixed top-0 left-0 right-0 z-50 bg-[#FA1690]/85 backdrop-blur-md border-b border-white/20 shadow-sm"> backdrop-blur-md border-b border-white/20 shadow-sm">
