...
const NutriCoach = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col overflow-x-hidden">
      <Navbar />
      <div className="flex-1 px-4 pt-[calc(env(safe-area-inset-top)+4rem)] <div className="flex-1 px-4 pt-[calc(env(safe-area-inset-top)+4rem)] pb-40 max-w-3xl mx-auto w-full space-y-4"> mx-auto w-full space-y-4">
        {/* Card título */}
