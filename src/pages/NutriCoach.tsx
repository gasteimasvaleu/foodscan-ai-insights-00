  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <Dialog open={chatOpen} onOpenChange={setChatOpen}>
        <DialogContent className="!fixed !inset-x-4 !top-20 !bottom-auto !left-4 !right-4 !w-auto !max-w-lg !mx-auto !translate-x-0 !translate-y-0 h-[55dvh] max-h-[55dvh] rounded-2xl bg-white border-2 border-primary shadow-xl p-0 flex flex-col gap-0 overflow-hidden box-border">
          {/* Header */}
