      ...
      <div className="min-h-screen bg-gradient-primary font-inter pt-16">
        <div className="container mx-auto px-4 py-[11px]">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            {isAnalyzing ? <div data-results-section>
                <LoadingState />
              </div> : nutritionData ? <div data-results-section>
                ...
                {/* Seção de Descrição */}
                {(selectedImage || imageDescription) && <div data-description-section className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/20">
                    ...
                    {isDescribing ? <div className="flex items-center space-x-2">
                        <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-primary-500"></div>
                        <span className="text-gray-600">Analisando imagem...</span>
                      </div> : <>
                        <Textarea value={imageDescription} onChange={e => setImageDescription(e.target.value)} placeholder="A descrição da imagem aparecerá aqui..." className="min-h-[200px] md:min-h-[250px] mb-4" />
                        
                        {imageDescription && <Button onClick={handleNutritionAnalysis} className="bg-primary-500 hover:bg-primary-600 text-white rounded-xl px-8">
                            Analisar Nutrição
                          </Button>}
                      </>}
                  </div>}
